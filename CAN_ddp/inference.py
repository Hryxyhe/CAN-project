...
parser.add_argument('--image_path', default='/home/ipad_ocr/CAN/datasets/CROHME/19_test_images.pkl', type=str, help='测试image路径')
parser.add_argument('--label_path', default='/home/ipad_ocr/CAN/datasets/CROHME/19_test_labels.txt', type=str, help='测试label路径')
parser.add_argument('--word_path', default='/home/ipad_ocr/CAN/datasets/CROHME/words_dict.txt', type=str, help='测试dict路径')
parser.add_argument('--model_path', default='/home/ipad_ocr/hmer_with_localization-ddp_amp_baseline/checkpoints/ExpRate-0.555781_189.pth', type=str, help='path of trained model')
