...
do
CUDA_VISIBLE_DEVICES=6 python inference.py --dataset CROHME --model_path $file_path --image_path datasets/CROHME/14_test_images.pkl --label_path datasets/CROHME/14_test_labels.txt
done